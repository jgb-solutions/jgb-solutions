...
Looking for traditional search engine optimization? See the [SEO guide](https://tanstack.com/start/latest/docs/framework/react/guide/seo).
[What is LLMO?](https://tanstack.com/start/latest/docs/framework/react/guide/llmo#what-is-llmo)
...
[How LLMO Differs from SEO](https://tanstack.com/start/latest/docs/framework/react/guide/llmo#how-llmo-differs-from-seo)
...
[What TanStack Start Provides](https://tanstack.com/start/latest/docs/framework/react/guide/llmo#what-tanstack-start-provides)
...
- Server Routes - Create machine-readable endpoints (APIs, feeds)
  [Structured Data for AI](https://tanstack.com/start/latest/docs/framework/react/guide/llmo#structured-data-for-ai)
...
[Article Schema](https://tanstack.com/start/latest/docs/framework/react/guide/llmo#article-schema)
...
[Product Schema](https://tanstack.com/start/latest/docs/framework/react/guide/llmo#product-schema)
...
[Organization and Website Schema](https://tanstack.com/start/latest/docs/framework/react/guide/llmo#organization-and-website-schema)
...
[FAQ Schema](https://tanstack.com/start/latest/docs/framework/react/guide/llmo#faq-schema)
...
[Machine-Readable Endpoints](https://tanstack.com/start/latest/docs/framework/react/guide/llmo#machine-readable-endpoints)
...
[Content Best Practices](https://tanstack.com/start/latest/docs/framework/react/guide/llmo#content-best-practices)

## Content Best Practices

Beyond technical implementation, content structure matters for LLMO:
[Clear, Factual Statements](https://tanstack.com/start/latest/docs/framework/react/guide/llmo#clear-factual-statements)
...
[Hierarchical Structure](https://tanstack.com/start/latest/docs/framework/react/guide/llmo#hierarchical-structure)
...
[Authoritative Attribution](https://tanstack.com/start/latest/docs/framework/react/guide/llmo#authoritative-attribution)
...
[llms.txt](https://tanstack.com/start/latest/docs/framework/react/guide/llmo#llmstxt)
...
[Monitoring AI Citations](https://tanstack.com/start/latest/docs/framework/react/guide/llmo#monitoring-ai-citations)
