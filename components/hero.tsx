  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between px-6 py-12 md:px-20 md:py-24">
      <div className="w-full md:w-1/2 mb-12 md:mb-0">
        <div className="text-sm md:text-base tracking-wider text-primary mb-4">innovate.lead.deliver.</div>
      ...
      <div className="w-full md:w-1/2 h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] relative">
        <Image
          src="https://cdn.prod.website-files.com/62673e4070051ac9b30ad8c7/626a08b7ad20d840cca00273_Header%20Image%20Large.png"
          alt="Jean Bousiquot"
          fill
