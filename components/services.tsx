...
const services = [
  {
    ...
    description: "I deliver end-to-end solutions with my expertise in both frontend and backend technologies.",
  },
  {
    title: "AI Integration",
    description: "Leverage my experience in implementing AI models to enhance your software capabilities.",
  },
  {
    title: "Tech Leadership",
    description: "Benefit from my proven track record in leading teams and delivering successful projects.",
  },
  {
